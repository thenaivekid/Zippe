...
AttachmentsTue, Mar 5, 10:25 PM (21 hours ago)
...
int main()
{
    ...
    string text = "huffman coding is done";
    ...
    //std::vector<std::pair<int, char>> compressed_data = lz78_compress(encodedText);
    ...
    cout << endl;
    //// decompress data
    std::string decodedText = decompressFile(decompressed_data, huffmanCodes);
